...
try {
  ...
  $subject  = "Changes requested in your final mobility process (PEF)";
  ...
  if ($comment !== "") {
    ...
    $commentText = "\nComment:\n" . $comment . "\n";
    $commentHtml = "<p><strong>Comment:</strong><br>" . nl2br($safeComment) . "</p>";
  }

  $text =
    $greeting . "\n\n" .
    "Changes were requested for your final process (PEF) " . $pid . ".\n" .
    "Please review the feedback in the platform, make the necessary corrections and resubmit.\n\n" .
    $commentText .
    "Best regards,\nMobility Website";

  $html =
    "<p>" . htmlspecialchars($greeting, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8") . "</p>" .
    "<p>Changes were requested for your final process (PEF) <strong>" .
    htmlspecialchars((string)$pid, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8") . "</strong>.<br>" .
    "Please review the feedback in the platform, make the necessary corrections and resubmit.</p>" .
    $commentHtml .
